  ...
  section Memory_model {
    text "Example .re types showing inheritance, field offsets, optional native function entry points, and bitfield and enum annotations. Replace sources and names with your binary's provenance."
  }
  section Inheritance {
